...
const baseProducts: Product[] = [
  ...
  { id: '9', name: 'Kopi Seduh', price: 15000, cost_price: 8000, stock: 0, ...getImageData('product-9'), track_stock: false, has_variant: true, has_modifier: true, is_active: true, product_type: 'food_and_beverage', category_id: 'cat-4', modifier_group_ids: ['mg1', 'mg2'], sku: 'COFFEE-BREW', is_composite: true },
